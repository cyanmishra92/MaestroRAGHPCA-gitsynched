...
Notably, our three-stage pipeline delivers an approximate $22\%$ improvement over the four-stage approach, primarily due to the reduced scheduler overhead. This performance is also significantly better than the naïve allocation strategy, which requires $9.5\,\mathrm{s}$ ($8.06\times$) for similar CPU execution.
...
%\input{TablesAlgos/AlgoCCPUMapping}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
 \begin{figure*} 
    ...
    {%
     % CR-REPLACED: \includegraphics[clip,width=0.32\linewidth]{Figs/4090LatencyOurs.pdf}%
    ...
    {%
     % CR-REPLACED: \includegraphics[clip,width=0.32\linewidth]{Figs/4090speedupEdgeRAG.pdf}%
    ...
    {%
     % CR-REPLACED: \includegraphics[clip,width=0.32\linewidth]{Figs/4090speedupFlashRAG.pdf}
    ...
    {%
    % CR-REPLACED: \includegraphics[clip,width=0.32\linewidth]{Figs/4090speedupPipeRAG.pdf}%
    ...
    {%
    % CR-REPLACED: \includegraphics[clip,width=0.32\linewidth]{Figs/4080Latency_MaestroRAG.pdf}%
    ...
    {%
    % CR-REPLACED: \includegraphics[clip,width=0.32\linewidth]{Figs/4080Speedup_Merged.pdf}%
    ...
    All speedups observed for MaestroRAG results from a concoction of optimizations presented in  \Cref{subsec:pipeline_design}, \Cref{subsec:resource-mapping}, and \Cref{sec:Design:Software}).
