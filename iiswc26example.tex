...
This and the iiswc26.cls file define the components of your paper [title, text, heads, etc.]. 
...
\texttt{iiswc26} template, including all of the correct options
...
The \texttt{iiswc26} class file is used to format your paper and style the text. All margins, 
...
Please note that double-blind submission guidelines apply 
to all submissions. If you are acknowledging generative AI tools used, it should be 
done in a way that does not break anonymity. 
