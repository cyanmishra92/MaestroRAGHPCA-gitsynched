...
\begin{figure*}
    ...
    \caption{\new{Stage placement in a classical RAG pipeline and in \design{}. The classical pipeline places both encoding and generation on the GPU; \design{} places encoding and retrieval on dedicated CPU cores and reserves the GPU for generation.}}
